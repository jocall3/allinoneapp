...
const implementedFeatures: Record<string, { loader: () => Promise<{ [key: string]: React.FC<any> }>, exportName: string }> = {
    ...
    'ai-assisted-debugging': { loader: () => import('./AiAssistedDebugging.tsx'), exportName: 'AiAssistedDebugging' },
    ...
    'automated-file-system-defragmentation-logical': { loader: () => import('./AutomatedLogicalDefragmentation.tsx'), exportName: 'AutomatedLogicalDefragmentation' },
